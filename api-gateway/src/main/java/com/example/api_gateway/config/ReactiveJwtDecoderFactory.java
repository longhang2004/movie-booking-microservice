...
final class ReactiveJwtDecoderFactory {

    private ReactiveJwtDecoderFactory() {
    }

    static ReactiveJwtDecoder create(String jwkSetUri, String publicKeyPem, String issuer, String audience) {
        NimbusReactiveJwtDecoder decoder;
        if (publicKeyPem != null && !publicKeyPem.isBlank()) {
            decoder = NimbusReactiveJwtDecoder.withPublicKey(parsePublicKey(publicKeyPem)).build();
